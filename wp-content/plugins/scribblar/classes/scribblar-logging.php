 ...
 * Scribblar Logging
 *
 * A set of functions to log messages from the scribblar API interactions.
 *
 * @author scribblar
 * @package scribblar
 * @since 1.0
 ...
 *
 */
class ScribblarLogging{

    private static $log_dir_path = '';
	private static $log_dir_url  = '';
    private static $error_log_filename = 'scribblar-error.log';
    private static $message_log_filename = 'scribblar-message.log';
    private static $extended_log_filename = 'scribblar-extended.log';
    private static $text_domain = 'scribblar';
