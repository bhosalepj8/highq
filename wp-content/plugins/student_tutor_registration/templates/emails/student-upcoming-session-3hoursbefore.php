...
do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
        ...
        <p><?php printf( __( 'This is to remind you of your tutoring/ coaching session with %s is scheduled today %s in <strong>3</strong> hours at %s.'),$data->tutor_name, $data->session_date, $data->session_time)?></p>
