...
<p>
	<?php echo apply_filters( 'woocommerce_my_account_my_address_description', __( '(The following address will be used on the checkout page by default.)', 'woocommerce' ) ); ?>
</p>
