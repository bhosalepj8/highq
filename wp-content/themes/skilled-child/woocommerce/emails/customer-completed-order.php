...
if($order->payment_method == 'paypal'){
    printf( __( "Thank you for booking your package. The details of the package purchased by you are as follows:", 'woocommerce' ), get_option( 'blogname' ) ); 
}else{
    printf( __( "Thank you for booking your session with %s! The details of your session are: ", 'woocommerce' ), get_option( 'blogname' ) ); 
}
?></p>


<?php
//var_dump($order->payment_method == 'paypal');die;
