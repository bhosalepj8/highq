...
if($order->payment_method == 'paypal'){
    printf( __( "Your order is on-hold until we confirm payment has been received. Your order details are shown below for your reference:", 'woocommerce' )); 
}else{
    printf( __( "Your session is on-hold until we confirm payment has been received. Your session details are shown below for your reference:", 'woocommerce' )); 
}
?></p>
