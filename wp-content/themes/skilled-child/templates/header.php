                                ...
                                <div>
                                    ...
                                    <?php }else{
                                      ...
                                      <form>
                                          ...
                                          <a class="exit-account" href="<?php echo wp_logout_url( get_permalink( woocommerce_get_page_id( 'myaccount' ) ) ) ?>"><input name="" value="Log Out" class="btn btn-primary btn-sm signin-button" type="button"></a>
                                        </form>
                                    </div>
                                    <?php }?>
                                </div>
